...
FlowRouter.route('/aplicar', {
    name: 'therapist-form',
    action() {
        BlazeLayout.render('LandingLayoutAlt', { main: 'registerTherapist' });
    }
});

FlowRouter.route('/aplicarAgente', {
    name: 'agent-form',
    action() {
        BlazeLayout.render('LandingLayoutAlt', { main: 'AgentForm' });
    }
});
...
FlowRouter.route('/admin', {
    ...
    action() {
        ...
        if(userId) {
            ...
            }else if(Roles.userIsInRole(userId,'agent')){
                FlowRouter.go('agent-book-now');
            }
        }
        else {
            FlowRouter.go('signin');
...
FlowRouter.route('/admin/agentes', {
    name: 'admin-agents',
    action() {
        BlazeLayout.render('MainLayout', { main: 'adminAgents' });
    }
});
FlowRouter.route('/admin/solicitudes/agentes', {
    name: 'admin-agents-requests',
    action() {
        BlazeLayout.render('MainLayout', { main: 'adminAgentsRequest' });
    }
});

FlowRouter.route('/admin/solicitudes/terapeutas', {
...
FlowRouter.route('/agent/ordenar', {
    name: 'agent-book-now',
    action() {
        BlazeLayout.render('MainLayout', { main: 'BookNowAgent' });
    }
});

FlowRouter.route('/agent/ordenes/historial', {
    name: 'agent-history-orders',
    action() {
        BlazeLayout.render('MainLayout', { main: 'HistoricalOrdersAgent' });
    }
});

FlowRouter.route('/agent/puntos', {
    name: 'agent-promoReward',
    action() {
        BlazeLayout.render('MainLayout', { main: 'PromoRewardAgent' });
    }
});

FlowRouter.route('/agent/encuesta/:id', {
    name: 'agent-survey',
    action() {
        BlazeLayout.render('MainLayout', { main: 'SurveyAgent' });
    }
});
